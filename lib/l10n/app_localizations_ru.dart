...
class AppLocalizationsRu extends AppLocalizations {
  ...
  String goAdBonusCoins(Object count) {
    return '🎉 +$count бонусных монет за просмотр!';
  }
  ...
  @override
  String get auBody =>
      'Гостевые аккаунты могут играть и сохранять прогресс локально, но не могут покупать предметы и оформлять подписку. Привяжите аккаунт, чтобы открыть покупки — ваши монеты, косметика и рекорды останутся с вами.';

  @override
  String get auApple => 'Продолжить с Apple';

  @override
  String get auAppleSub =>
      'Войдите с Apple ID. Ваш адрес почты может остаться скрытым.';
  ...
  String updateAvailableBody(String version) {
    return 'Snake Classic $version уже в App Store. Обновите, чтобы получить новые возможности и исправления.';
  }
  ...
  String get updateRequiredBody =>
      'Эта версия Snake Classic больше не поддерживается. Обновите приложение в App Store, чтобы продолжить игру.';
