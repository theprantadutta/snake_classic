...
class AppLocalizationsHi extends AppLocalizations {
  ...
  @override
  String get auBody =>
      'गेस्ट अकाउंट खेल सकते हैं और प्रगति लोकल में सेव कर सकते हैं, पर खरीदारी या सब्सक्रिप्शन नहीं कर सकते। खरीदारी अनलॉक करने के लिए अकाउंट लिंक करें — आपके मौजूदा सिक्के, कॉस्मेटिक्स और हाई स्कोर जुड़े रहेंगे।';

  @override
  String get auApple => 'Apple के साथ जारी रखें';

  @override
  String get auAppleSub =>
      'अपनी Apple ID से साइन इन करें। आपका ईमेल निजी रह सकता है।';
